...
describe('PostGIS Data Source', function() {
  describe('Projects between a Web Mercator (meters) Map and a Lat/Lon PostGIS data source', function() {
    ...
    var pgStub = sinon.stub(pg, 'connect').yields(null, { query: querySpy }, function() {});
    ...
    describe('Retrieves rows as GeoJson and Projects/transforms from the datasource projection to the map\s', function() {
